...
**Current state:** build 34 — Phase A complete + i18n + visual refresh + tests + scheduler fix + multiple-choice + encouraging reveal + speaking-first "Üben" + "can't speak" fallback, on TestFlight (personal).
