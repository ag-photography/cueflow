...
**Current state:** build 35 — Phase A complete + i18n + visual refresh + tests + speaking-first "Üben" (+ can't-speak fallback) + one-tap reveal (no 4-button rating), on TestFlight (personal).
