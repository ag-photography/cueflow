...
**Current state:** build 36 — Phase A complete + i18n + visual refresh + tests + speaking-first "Üben" (+ can't-speak fallback) + one-tap reveal + **Sprint** (60-sec hands-free fluency round), on TestFlight (personal).
