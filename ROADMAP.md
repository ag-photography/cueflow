...
**Current state:** build 37 — Phase A complete + i18n + visual refresh + tests + speaking-first "Üben" + one-tap reveal + **Sprint** (60-sec hands-free fluency round) + **speaking scoreboard** (Profile "Sprechen" section: words spoken today, 7-day chart, Sprint best, fluency trend), on TestFlight (personal).
